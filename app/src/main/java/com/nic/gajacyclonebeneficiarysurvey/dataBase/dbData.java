package com.nic.gajacyclonebeneficiarysurvey.dataBase;
...
public class dbData {
    ...
    /****** VILLAGE TABLE *****/
    public GajaCycloneBeneficiarySurvey insertVillage(GajaCycloneBeneficiarySurvey pmgsySurvey) {
    ...
    public ArrayList<GajaCycloneBeneficiarySurvey > getAll_Village(String dcode,String bcode) {

        ArrayList<GajaCycloneBeneficiarySurvey > cards = new ArrayList<>();
        Cursor cursor = null;
        ...
        try {
            ...
            if (cursor.getCount() > 0) {
                while (cursor.moveToNext()) {
                    GajaCycloneBeneficiarySurvey  card = new GajaCycloneBeneficiarySurvey ();
    ...
    public GajaCycloneBeneficiarySurvey insertHabitation(GajaCycloneBeneficiarySurvey pmgsySurvey) {
    ...
    public ArrayList<GajaCycloneBeneficiarySurvey > getAll_Habitation(String dcode,String bcode) {
    ...
    public GajaCycloneBeneficiarySurvey insertPMAY(GajaCycloneBeneficiarySurvey pmgsySurvey) {
    ...
    public ArrayList<GajaCycloneBeneficiarySurvey > getAll_PMAYList(String pvcode,String habcode) {
    ...
    public ArrayList<GajaCycloneBeneficiarySurvey> getSavedPMAYDetails() {
...
//                    new String[]{"*"}, selection, selectionArgs, null, null, null);
    ...
    public ArrayList<GajaCycloneBeneficiarySurvey> getSavedPMAYImages(String pmay_id, String type_of_photo) {
