...
public class CommonAdapter extends BaseAdapter {
    private List<GajaCycloneBeneficiarySurvey> pmgsySurveys;
    private Context mContext;
    private String type;


    public CommonAdapter(Context mContext, List<GajaCycloneBeneficiarySurvey> pmgsySurvey, String type) {
...
//        TextView tv_type = (TextView) view.findViewById(R.id.tv_spinner_item);
        ...
        GajaCycloneBeneficiarySurvey pmgsySurvey = pmgsySurveys.get(position);
