...
import com.nic.gajacyclonebeneficiarysurvey.activity.PendingScreen;
...
import com.nic.gajacyclonebeneficiarysurvey.databinding.PendingAdapterBinding;
...
import static com.nic.gajacyclonebeneficiarysurvey.activity.HomePage.db;

public class PendingAdapter extends RecyclerView.Adapter<PendingAdapter.MyViewHolder> {

    private static Activity context;
    private PrefManager prefManager;
    private List<GajaCycloneBeneficiarySurvey> pendingListValues;
    static JSONObject dataset = new JSONObject();

    private LayoutInflater layoutInflater;

    public PendingAdapter(Activity context, List<GajaCycloneBeneficiarySurvey> pendingListValues) {
