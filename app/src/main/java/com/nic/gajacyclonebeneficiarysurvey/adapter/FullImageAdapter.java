...
import com.nic.gajacyclonebeneficiarysurvey.databinding.GalleryThumbnailBinding;
...
public class FullImageAdapter extends RecyclerView.Adapter<FullImageAdapter.MyViewHolder> {
    ...
    private List<GajaCycloneBeneficiarySurvey> imagePreviewlistvalues;
    private final com.nic.gajacyclonebeneficiarysurvey.dataBase.dbData dbData;
    private LayoutInflater layoutInflater;

    public FullImageAdapter(Context context, List<GajaCycloneBeneficiarySurvey> imagePreviewlistvalues, dbData dbData) {
