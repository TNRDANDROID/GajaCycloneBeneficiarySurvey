...
import com.nic.gajacyclonebeneficiarysurvey.databinding.TakePhotoBinding;
...
public class TakePhotoScreen extends AppCompatActivity {
    ...
    public void onBackPressed() {
        dbData.open();
        ArrayList<GajaCycloneBeneficiarySurvey> imageOffline = dbData.getSavedPMAYImages(pmay_id,"");
