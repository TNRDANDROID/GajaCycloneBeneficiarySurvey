...
import com.nic.gajacyclonebeneficiarysurvey.Fragment.SlideshowDialogFragment;
import com.nic.gajacyclonebeneficiarysurvey.R;
import com.nic.gajacyclonebeneficiarysurvey.adapter.FullImageAdapter;
...
import com.nic.gajacyclonebeneficiarysurvey.databinding.FullImageRecyclerBinding;
...
public class FullImageActivity extends AppCompatActivity implements View.OnClickListener, Api.ServerResponseListener {
    ...
    private static  ArrayList<GajaCycloneBeneficiarySurvey> activityImage = new ArrayList<>();
    private com.nic.gajacyclonebeneficiarysurvey.dataBase.dbData dbData = new dbData(this);
    @Override
...
//        work_id = ;
    ...
    public class fetchImagetask extends AsyncTask<Void, Void,
        ...
        @Override
        protected void onPostExecute(final ArrayList<GajaCycloneBeneficiarySurvey> imageList) {
    ...
    public JSONObject ImagesListJsonParams() throws JSONException {
        ...
        dataSet.put(AppConstant.SURVEY_REG_ID, getIntent().getStringExtra(AppConstant.SURVEY_REG_ID));
    ...
    public void generateImageArrayList(JSONArray jsonArray){
        if(jsonArray.length() > 0){
            ...
            for(int i = 0; i < jsonArray.length(); i++ ) {
                try {
                    GajaCycloneBeneficiarySurvey imageOnline = new GajaCycloneBeneficiarySurvey();
