...
import com.nic.gajacyclonebeneficiarysurvey.adapter.ViewServerDataListAdapter;
...
import com.nic.gajacyclonebeneficiarysurvey.databinding.ViewServerDataScreenBinding;
...
public class ViewServerDataScreen extends AppCompatActivity implements Api.ServerResponseListener {
    ...
    public class fetchScheduletask extends AsyncTask<Void, Void,
        ...
        protected ArrayList<GajaCycloneBeneficiarySurvey> doInBackground(Void... params) {
            dbData.open();
            ArrayList<GajaCycloneBeneficiarySurvey> savedList = new ArrayList<>();
        ...
        @Override
        protected void onPostExecute(ArrayList<GajaCycloneBeneficiarySurvey> savedList) {
